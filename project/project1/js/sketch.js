var p5_colors = new p5(function(sketch){
	...
	sketch.preload = function() {
		MNTable1 = sketch.loadTable('../../project/project1/data/part1.csv', 'csv', 'header'); // tell it read the first row as header
	}
...
var p5_bubbles = new p5(function(sketch) {
	...
	sketch.preload = function() {
		MNTable2 = sketch.loadTable('../../project/project1/data/part2.csv', 'csv', 'header'); // tell it read the first row as header
